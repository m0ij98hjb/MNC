        ...
        <div className={`flex flex-col ${lang === 'ar' ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12 lg:gap-20`}>
          ...
          <div className="w-full lg:w-1/2 relative" data-aos="fade-up">
            <div className="relative z-10 group">
              ...
              {/* Floating Badge */}
              <div className={`absolute -bottom-4 ${lang === 'ar' ? '-right-2' : '-left-2'} md:-bottom-6 ${lang === 'ar' ? 'md:-right-6 lg:-right-10' : 'md:-left-6 lg:-left-10'} bg-white p-4 md:p-6 rounded-2xl shadow-2xl border border-[rgba(15,23,42,0.06)] z-20`} data-aos="zoom-in" data-aos-delay="400">
              ...
              {/* Decorative Frame */}
              <div className={`absolute -top-4 ${lang === 'ar' ? '-left-2 md:-top-6 md:-left-6' : '-right-2 md:-top-6 md:-right-6'} w-20 h-20 md:w-32 md:h-32 ${lang === 'ar' ? 'border-t-4 border-l-4 rounded-tl-3xl' : 'border-t-4 border-r-4 rounded-tr-3xl'} border-secondary -z-10`}></div>
            </div>

            {/* Director Title Card */}
            <div className={`absolute -bottom-10 ${lang === 'ar' ? 'left-2 md:left-6 lg:-left-10' : 'right-2 md:right-6 lg:-right-10'} bg-white  backdrop-blur-md p-4 md:p-5 rounded-xl border border-[rgba(255,255,255,0.08)] shadow-2xl z-20`} data-aos="fade-up" data-aos-delay="500">
