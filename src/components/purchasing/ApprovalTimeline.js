...
import {
  ...
  ShoppingCart, Truck, PackageCheck, Archive as ArchiveIcon, AlertTriangle, Boxes, Pencil, PenLine,
} from 'lucide-react';
...
const ACTION_ICON = {
  ...
  project_manager_signed: { icon: PenLine, cls: 'bg-indigo-500/15 border-indigo-500/40 text-indigo-400' },
...
const APPROVAL_ACTIONS = ['submitted', 'resubmitted', 'project_manager_signed', 'approved_stage', 'reject', 'return'];
