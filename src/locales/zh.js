export const zh = {
  ...
  voice: {
    ...
    play: "播放介绍",
    intro: "公司介绍",
    text: "MNC通用承包公司——沙特阿拉伯建筑卓越领域的杰出品牌。我们将工程传统与现代视野相结合，将蓝图转化为充满品质与生命力的建筑地标。我们的综合服务涵盖建筑施工、建筑设计、项目管理和室内设计。在工程师马尔万·艾哈迈德·纳泽尔的领导下，我们在十五年多的时间里取得了卓越成就。今天就联系我们，获取免费专业咨询。"
  },
  careers: {
