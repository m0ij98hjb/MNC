...
export default function ApprovedSuppliersPage() {
  ...
  return (
    <div className="p-6 lg:p-8" dir="ltr">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">Approved Suppliers</h1>
        <p className="text-sm text-white/40 mt-1">
          Approved supplier database —{' '}
          <strong className="text-[#c8a96e]">{suppliers.length}</strong> total
          {hasFilters && <> · <strong className="text-white/60">{visible.length}</strong> shown</>}
        </p>
      </div>
